...
import joonleestudio.webrtc.RoomParametersFetcher.RoomParametersFetcherEvents;
import joonleestudio.webrtc.WebSocketChannelClient.WebSocketChannelEvents;
import joonleestudio.webrtc.WebSocketChannelClient.WebSocketConnectionState;
import joonleestudio.webrtc.util.AsyncHttpURLConnection;
import joonleestudio.webrtc.util.AsyncHttpURLConnection.AsyncHttpEvents;
...
public class WebSocketRTCClient implements AppRTCClient, WebSocketChannelEvents {
  ...
  private void connectToRoomInternal() {
    ...
    new joonleestudio.webrtc.RoomParametersFetcher(connectionUrl, null, callbacks).makeRequest();
  }
