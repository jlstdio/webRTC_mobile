...
import joonleestudio.webrtc.util.AppRTCUtils;
...
public class AppRTCBluetoothManager {
  ...
  private final joonleestudio.webrtc.AppRTCAudioManager apprtcAudioManager;
  @Nullable
  ...
  /** Construction. */
  static AppRTCBluetoothManager create(Context context, joonleestudio.webrtc.AppRTCAudioManager audioManager) {
    Log.d(TAG, "create" + AppRTCUtils.getThreadInfo());
    return new AppRTCBluetoothManager(context, audioManager);
  }

  protected AppRTCBluetoothManager(Context context, joonleestudio.webrtc.AppRTCAudioManager audioManager) {
    Log.d(TAG, "ctor");
