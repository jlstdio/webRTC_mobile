...
public class HudFragment extends Fragment {
  ...
  private joonleestudio.webrtc.CpuMonitor cpuMonitor;
  ...
  public void onStart() {
    ...
    if (args != null) {
      videoCallEnabled = args.getBoolean(joonleestudio.webrtc.CallActivity.EXTRA_VIDEO_CALL, true);
      displayHud = args.getBoolean(joonleestudio.webrtc.CallActivity.EXTRA_DISPLAY_HUD, false);
    }
  ...
  public void setCpuMonitor(joonleestudio.webrtc.CpuMonitor cpuMonitor) {
  ...
  public void updateEncoderStatistics(final StatsReport[] reports) {
    ...
    for (StatsReport report : reports) {
      if (report.type.equals("ssrc") && report.id.contains("ssrc") && report.id.contains("send")) {
        ...
        if (trackId != null && trackId.contains(joonleestudio.webrtc.PeerConnectionClient.VIDEO_TRACK_ID)) {
